...
if __name__ == "__main__":
    ...
    ap.add_argument("--voice-owner", action="store_true",
                    help="THE FIX: key each voice's LFO4 row on the live sound that owns the voice")
    ...
    raise SystemExit(bridge.main(sources=SOURCES, entries=ui2.ENTRIES,
                                 ...
                                 defines={"LFO4_KEEP_ROWS": 1, "LFO4_KEEP_ALL": 1,
                                          ...
                                          **({"LFO4_VOICE_OWNER": 1} if cli.voice_owner else {}),
