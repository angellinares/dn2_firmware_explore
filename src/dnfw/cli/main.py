...
from . import build, disasm, extract, inspect, params, patch, symbols, validate_disasm

COMMANDS = (inspect, extract, build, patch, symbols, params, disasm, validate_disasm)
