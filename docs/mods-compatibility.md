...
<!-- dnfw:matrix -->
| | `arpmodes` | `arpplocks` | `bootscreen` | `fxmod` | `lfo4` | `lfowaves` | `midiarp` | `moddest` | `songguard` | `transients` | `waverider` |
|---|---|---|---|---|---|---|---|---|---|---|---|
| `arpmodes` | - | yes | yes | yes | yes | yes | yes | yes | yes | yes | yes |
| `arpplocks` | yes | - | order | **NO** | yes | yes | yes | yes | yes | yes | yes |
| `bootscreen` | yes | order | - | yes | **NO** | **NO** | yes | yes | yes | yes | yes |
| `fxmod` | yes | **NO** | yes | - | order | yes | yes | yes | yes | yes | **NO** |
| `lfo4` | yes | yes | **NO** | order | - | **NO** | yes | order | yes | yes | **NO** |
| `lfowaves` | yes | yes | **NO** | yes | **NO** | - | yes | yes | yes | yes | yes |
| `midiarp` | yes | yes | yes | yes | yes | yes | - | yes | yes | yes | yes |
| `moddest` | yes | yes | yes | yes | order | yes | yes | - | yes | yes | yes |
| `songguard` | yes | yes | yes | yes | yes | yes | yes | yes | - | yes | yes |
| `transients` | yes | yes | yes | yes | yes | yes | yes | yes | yes | - | **NO** |
| `waverider` | yes | yes | yes | **NO** | **NO** | yes | yes | yes | yes | **NO** | - |
